...
import { getAuth, GithubAuthProvider, GoogleAuthProvider, sendEmailVerification, updateProfile } from "firebase/auth";
         ...
         <div className="mx-auto mt-5 container row row-cols-1 row-cols-md-2 my-5 py-5 align-items-start">
            <div className="col-12 col-md-8 d-flex flex-column justify-content-center align-items-center">
               <div className="text-lg-start">
                  <h1 className="display-3 mb-4">Please Register!</h1>
                  <h2 className="display-4">Welcom to the Gain Talent!</h2>
               </div>
            </div>
